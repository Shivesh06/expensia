...
export default function EmailTemplate({
  ...
  const income = safeStats.totalIncome || 0;
  const expenses = safeStats.totalExpenses || 0;
        ...
        <Body style={styles.body}>
          <Container style={styles.container}>
            ...
            {data?.insights && data.insights.length > 0 && (
              <Section style={styles.section}>
                <Heading style={styles.heading}>Expensia Insights</Heading>
            ...
            <Text style={styles.footer}>
              Thank you for using Expensia. Keep tracking your finances for better
              financial health!
            </Text>
          </Container>
        </Body>
            ...
            <Section style={styles.statsContainer}>
              ...
              <div style={styles.stat}>
                ...
                <Text style={styles.heading}>
                  ₹{(budgetAmount - totalExpenses).toFixed(2)}
                </Text>
              </div>
            </Section>
          </Container>
